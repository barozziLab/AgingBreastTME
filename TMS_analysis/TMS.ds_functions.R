...
custom_dotplot <- function(so, features, color_pal, idents = NULL, cluster.idents = FALSE, assay = "SCT", split.by = NULL) {
  ...
  dp <- DotPlot(so, features = features, cluster.idents = cluster.idents, split.by = split.by, idents = clusters)
